...
python3 main.py --max_epochs=100 --dataset=GEXADT --model=CLASSIFIER --seed=$SLURM_ARRAY_TASK_ID --eval_interval=100
python3 main.py --max_epochs=100 --dataset=GEXADT --model=VAE --seed=$SLURM_ARRAY_TASK_ID --eval_interval=100
