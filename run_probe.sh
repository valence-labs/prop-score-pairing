...
python3 probing.py --checkpoint=$checkpoint_classifier --max_epochs=50 --seed=$SLURM_ARRAY_TASK_ID 
python3 probing.py --checkpoint=$checkpoint_vae --max_epochs=50 --seed=$SLURM_ARRAY_TASK_ID 
python3 probing.py --checkpoint=random --max_epochs=50 --seed=$SLURM_ARRAY_TASK_ID 
python3 probing.py --checkpoint=gt --max_epochs=50 --seed=$SLURM_ARRAY_TASK_ID 
